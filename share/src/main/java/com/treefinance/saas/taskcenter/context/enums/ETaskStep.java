...
public enum ETaskStep {
    ...
    private final String text;// 指令日志信息
    private final String stageCode;// 阶段编码
    private final String stageText;// 阶段信息
    private final String stepCode;// 环节编码
    private final String stepText;// 环节信息
