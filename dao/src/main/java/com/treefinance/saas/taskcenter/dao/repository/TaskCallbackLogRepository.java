...
public interface TaskCallbackLogRepository {
    ...
    void insertOrUpdateLog(Long taskId, Byte type, Long configId, String url, String requestParam, String responseData,
        int httpCode, String callbackCode, String callbackMsg, int consumeTime);
