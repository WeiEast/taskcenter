 ...
 */
@Component("taskTimeoutCheckSchedule")
public class TaskTimeoutCheckJob extends BaseSingleJob {
    @Autowired
    ...
    protected void process() {
        ...
        try {
            for (Task task : tasks) {
                taskTimeoutDetector.detect(task.getId());
            }
        } catch (InterruptedException e) {
            logger.warn("TaskTimeoutCheckJob was interrupted!", e);
        }
    }
